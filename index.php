...
$connect = new PDO("mysql:host=localhost; dbname=testing", "habib", "787898");
...
if(isset($_POST["register"]))
{
	...
	if($error_user_name == '' && $error_user_email == '' && $error_user_password == '')
	{
		...
		else
		{
			...
			$mail->Port = '465';
			$mail->SMTPAuth = true;
			$mail->Username = 'anuhimel2@gmail.com';
			$mail->Password = '0nusrat0';
			$mail->SMTPSecure = 'ssl';
			$mail->From = 'anuhimel2@gmail.com';
			$mail->FromName = 'Habib';
